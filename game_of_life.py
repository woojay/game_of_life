'''
    ...
    4.  For manual entry, 10x40 grid will show up, which is the 'universe.'  You can move around the cursor position
            with arrow keys.
        4.1.  Hit space to place a seed.  Do as many as you like, and hit END key to exit the set up mode.
...
def get_manual_seeds(stdscr):
    ...
    stdscr.addstr(height + 2, 0, 'Use arrow keys to move the cursor.  Enter a space to place a seed. Hit END key to finish. ')
